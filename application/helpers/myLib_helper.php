...
function fd_verify($val = null)
{
    $option = [
        '1' => '<span class="badge badge-warning badge-pill">menunggu</span>',
        '2' => '<span class="badge badge-info badge-pill">proses</span>',
        '3' => '<span class="badge badge-success badge-pill">selesai</span>',
        '4' => '<span class="badge badge-danger badge-pill">ditolak</span>',
    ];
    if (empty($val)) :
        return $option;
    else :
