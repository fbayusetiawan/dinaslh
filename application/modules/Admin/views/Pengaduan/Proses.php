                        ...
                        <?php foreach ($data as $row) : ?>
                            <tr>
                                ...
                                <td width="100" class="text-center">
                                    ...
                                    <a href="<?= base_url($linkin . '/Setuju/' . $row->idPengaduan) ?>" class="btn btn-primary btn-sm" data-toggle="tooltip" title="Setujui Laporan"><i class="uil uil-check"></i></a>
                                        <a href="<?= base_url($linkin . '/Tolak/' . $row->idPengaduan) ?>" class="btn btn-danger btn-sm" data-toggle="tooltip" title="Tolak Laporan"><i class="uil uil-edit"></i></a>
