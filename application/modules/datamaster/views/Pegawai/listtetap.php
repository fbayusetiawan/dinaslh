...
<div class="row page-title">
    ...
    <!-- <nav aria-label="breadcrumb" class="float-right mt-1">
            <ol class="breadcrumb">
                <li><a href="<?= base_url($linkin . '/add1') ?>" class="btn btn-success">Tambah Pegawai Kontrak</a></li>
            </ol>
        </nav> -->
        <nav aria-label="breadcrumb" class="float-right mt-1">
            <ol class="breadcrumb">
                <li><a href="<?= base_url($linkin . '/add') ?>" class="btn btn-success">Tambah Pegawai Tetap</a></li>
            </ol>
        </nav>
        
        <h4 class="mb-1 mt-0">Data <?= $title ?> PNS</h4>
    </div>
</div>
<div class="row">
    <div class="col-12">
