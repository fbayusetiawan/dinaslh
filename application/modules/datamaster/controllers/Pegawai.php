...
class Pegawai extends CI_Controller
{
    ...
    public function listtetap()
    {
        $data['title'] = $this->titles;
        $data['pageTitle'] = "Data " . $this->titles;
        $data['data'] = $this->primaryModel->getAllData1();

        $this->template->load('template', $this->vn . '/listtetap', $data);
    }
    public function listhonor()
    {
        $data['title'] = $this->titles;
        $data['pageTitle'] = "Data " . $this->titles;
        $data['data'] = $this->primaryModel->getAllData2();

        $this->template->load('template', $this->vn . '/listhonor', $data);
    }
    ...
    function add1()
    {
        $data['title'] = $this->titles;
        $data['pageTitle'] = "Tambah Data " . $this->titles;
        $this->template->load('template', $this->vn . '/add1', $data);
    }
    ...
    function addAction1()
    {
        $this->primaryModel->save1($this->upload_foto());
        redirect('datamaster/' . $this->vn);
    }
