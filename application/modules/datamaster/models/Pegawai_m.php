...
class Pegawai_m extends CI_Model
{
    ...
    function save($foto)
    {
        $object = [
            ...
            'tanggalSelesai' => htmlspecialchars($this->input->post('tanggalSelesai', TRUE)),
            ...
            'statusKepegawaian' => '1',
            'idDevisi' => htmlspecialchars($this->input->post('idDevisi', TRUE)),
            'idPangkat' => htmlspecialchars($this->input->post('idPangkat', TRUE)),
