        ...
        <div class="navbar navbar-expand flex-column flex-md-row navbar-custom">
            <div class="container-fluid">
                ...
                <a href="index.html" class="navbar-brand mr-0 mr-md-2 logo">
                    <span class="logo-lg">
                        <img src="<?= base_url() ?>upload/dinaslh.png" alt="" height="50" />
                        <span class="d-inline h5 ml-1 text-logo">PELAYANAN PENGADUAN DINAS LINGKUNGAN HIDUP KOTA BANJARMASIN</span>
                    </span>
                    <span class="logo-sm">
                        <img src="<?= base_url() ?>upload/dinaslh.png" alt="" height="24">
                    </span>
                </a>
        ...
        <div class="content-page">
            ...
            <footer class="footer">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-12">
                            <?= date('Y') ?> &copy; Dinas Lingkungan Hidup Kota Banjarmasin. All Rights Reserved.
                        </div>
                    </div>
                </div>
            </footer>
